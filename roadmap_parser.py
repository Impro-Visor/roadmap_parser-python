...
def generateBricks(roadmaps,printVerbose=False):
    ...
    for roadmap in roadmaps:
        parseRoadmap(roadmap,brickDict=bricks,multChords=True,surface=False,justName=False,justKey=False,includeVar=False,includeDur=False,verbose=False)
    sortChords(bricks)
...
def generateProbmats(roadmaps,titles):
    ...
    bricks2 = []
    for roadmap in roadmaps:
        bricklist = parseRoadmap(roadmap,brickList=bricks2,surfaceList=True,justName=False,justKey=False,
